...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Permissions per = new Permissions(this);
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //intent.putExtra("nada", true);
            //startActivity(intent);

            showProgress(true);
            mAuthTask = new UserLoginTask(mEmailView.getText().toString(), password);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                /*
                String token = "", method = "soma";
                String url =  "192.168.25.6/servprod/index.php/" + method;
                ...
                request.addProperty("passwd", "123");

                //Vector v = new Vector();
                //v.add("android_teste");
                //v.add("teste2");
                //v.add("teste3");
                //request.addProperty("m_vector", v);
